import glob
from tools import get_all_Pk, get_all_red_Pk, get_mat_Pk, write_asdf, get_Pk_splits
import argparse
import logging
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Compute Abacus Pks from data splits.')
