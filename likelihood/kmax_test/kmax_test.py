...
if bias_model != 'HOD' and bias_model != 'HZPT':
    for b in bpar:
        for i in bin_nos:
    ...
    for i, b in enumerate(bpar):
        for i in bin_nos:
            param_name = input_params_prefix+'_cl'+str(i+1)+'_'+b
            if param_name in fit_params:
                ...
                elif( 'R12' in param_name ):
                    info['params'][param_name] = R12_param.copy()
